...
```bash
INIT=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" init list-workspaces)
