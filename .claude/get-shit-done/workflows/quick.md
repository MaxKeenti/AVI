...
```bash
INIT=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
AGENT_SKILLS_EXECUTOR=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-executor 2>/dev/null)
...
AGENT_SKILLS_VERIFIER=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-verifier 2>/dev/null)
```
...
```bash
node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
