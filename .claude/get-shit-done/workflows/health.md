...
```bash
node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
...
TASKS_DIR="/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/tasks"
if [ -d "$TASKS_DIR" ]; then
  STALE_COUNT=$( (find "$TASKS_DIR" -maxdepth 1 -type d -mtime +1 2>/dev/null || true) | wc -l )
  if [ "$STALE_COUNT" -gt 0 ]; then
    echo "⚠️  Found $STALE_COUNT stale task directories in /Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/tasks/"
    echo "   These are leftover from crashed subagent sessions."
    echo "   Run: rm -rf /Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/tasks/*  (safe — only affects dead sessions)"
  fi
fi
```
