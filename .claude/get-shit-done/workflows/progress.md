...
```bash
INIT=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
DEBT=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" audit-uat --raw 2>/dev/null)
```
...
```bash
PHASE_SECTION=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${CURRENT_PHASE}" 2>/dev/null)
...
```bash
NEXT_PHASE_SECTION=$(node "/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/UPIICSA/Plan 2021/2026 2/6NM69 Ambientes Virtuales/AVI/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "$((Z+1))" 2>/dev/null)
